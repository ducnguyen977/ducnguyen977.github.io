...
const { ChevronDown, ChevronRight, FileText } = lucide;
...
const VASPComprehensiveDoc = () => {
  ...
  return React.createElement('div', { className: "min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-6" },
    React.createElement('div', { className: "max-w-5xl mx-auto" },
      // Header
      React.createElement('div', { className: "bg-gradient-to-r from-green-700 to-emerald-600 text-white rounded-t-2xl p-8 shadow-2xl" },
        React.createElement('div', { className: "flex items-center gap-4 mb-4" },
          React.createElement(FileText, { className: "w-12 h-12" }),
          React.createElement('div', null,
            React.createElement('h1', { className: "text-3xl font-bold" }, "TÀI LIỆU TỔNG HỢP"),
            React.createElement('p', { className: "text-green-100 text-lg" }, "VASP & Quy định quản lý tài sản mã hóa tại Việt Nam")
          )
        ),
        React.createElement('div', { className: "bg-green-800/30 rounded-lg p-4 mt-4" },
          React.createElement('p', { className: "text-sm" }, "📋 Tài liệu chi tiết về Nghị quyết 05/2025/NQ-CP và 222/2025/QH15")
        )
      ),

      // Content
      React.createElement('div', { className: "bg-white rounded-b-2xl shadow-2xl" },
        React.createElement('div', { className: "p-6" },
          sections.map((section) =>
            React.createElement('div', { key: section.id, className: "mb-4 border-b border-gray-200 last:border-b-0" },
              section.isComparison ? 
                React.createElement('div', { className: "pb-6" },
                  React.createElement('h2', { className: "text-xl font-bold text-green-800 mb-4" }, section.title),
                  
                  React.createElement('div', { className: "bg-green-50 rounded-lg p-6 mb-6" },
                    React.createElement('h3', { className: "font-semibold text-lg text-green-900 mb-4" }, "So sánh hai Nghị quyết"),
                    
                    React.createElement('div', { className: "overflow-x-auto" },
                      React.createElement('table', { className: "w-full border-collapse" },
                        React.createElement('thead', null,
                          React.createElement('tr', { className: "bg-green-700 text-white" },
                            React.createElement('th', { className: "border border-green-600 p-3 text-left" }, "Tiêu chí"),
                            React.createElement('th', { className: "border border-green-600 p-3 text-left" }, "Nghị quyết số 05/2025/NQ-CP"),
                            React.createElement('th', { className: "border border-green-600 p-3 text-left" }, "Nghị quyết số 222/2025/QH15")
                          )
                        ),
                        React.createElement('tbody', null,
                          React.createElement('tr', null,
                            React.createElement('td', { className: "border border-gray-300 p-3 font-semibold bg-gray-50" }, "Cơ quan ban hành"),
                            React.createElement('td', { className: "border border-gray-300 p-3" }, "Chính phủ"),
                            React.createElement('td', { className: "border border-gray-300 p-3" }, "Quốc hội")
                          ),
                          React.createElement('tr', null,
                            React.createElement('td', { className: "border border-gray-300 p-3 font-semibold bg-gray-50 align-top" }, "Mục tiêu"),
                            React.createElement('td', { className: "border border-gray-300 p-3" },
                              React.createElement('ul', { className: "list-disc ml-4 space-y-2" },
                                React.createElement('li', null, "Thể chế hóa chủ trương, đường lối của Đảng tại các Nghị quyết số 52-NQ/TW ngày 27/9/2019 và Nghị quyết số 57-NQ/TW ngày 22/12/2024"),
                                React.createElement('li', null, "Thiết lập khung pháp lý để thí điểm thị trường TSMH tại Việt Nam"),
                                React.createElement('li', null, "Thực hiện cam kết của Chính phủ về PCRT/TTKB/PBVKHDHL"),
                                React.createElement('li', null, "Bảo vệ nhà đầu tư khi tham gia thị trường tài sản mã hóa tại Việt Nam")
                              )
                            ),
                            React.createElement('td', { className: "border border-gray-300 p-3" },
                              React.createElement('ul', { className: "list-disc ml-4 space-y-2" },
                                React.createElement('li', null, "Thể chế hóa các chủ trương, đường lối của Đảng"),
                                React.createElement('li', null, "Xây dựng TTTCQT tại TP. Hồ Chí Minh và TP. Đà Nẵng theo mô hình thống nhất quản lý, có định hướng phát triển sản phẩm riêng, phát huy lợi thế từng địa phương"),
                                React.createElement('li', null, "TTTCQT vận hành theo các chuẩn mực quốc tế tiên tiến, kết nối với các thị trường và trung tâm tài chính lớn trên thế giới")
                              )
                            )
                          )
                        )
                  ...
                  React.createElement('div', { className: "space-y-4" },
                    React.createElement('div', { className: "bg-blue-50 rounded-lg p-4" },
                      React.createElement('h4', { className: "font-semibold text-blue-900 mb-2" }, "📌 Về phạm vi và cấp độ:"),
                      React.createElement('ul', { className: "list-disc ml-6 space-y-2 text-gray-700" },
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 05/2025/NQ-CP:"),
                          " Do Chính phủ ban hành, tập trung vào thí điểm thị trường tài sản mã hóa, quy định cụ thể về VASP, điều kiện cấp phép, hoạt động"
                        ),
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 222/2025/QH15:"),
                          " Do Quốc hội ban hành, phạm vi rộng hơn về thành lập và vận hành TTTCQT tại TP.HCM và Đà Nẵng với cơ chế đặc thù"
                        )
                      )
                    ),

                    React.createElement('div', { className: "bg-purple-50 rounded-lg p-4" },
                      React.createElement('h4', { className: "font-semibold text-purple-900 mb-2" }, "🎯 Về mục tiêu:"),
                      React.createElement('ul', { className: "list-disc ml-6 space-y-2 text-gray-700" },
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 05:"),
                          " Thí điểm có kiểm soát, bảo vệ nhà đầu tư, thực hiện cam kết quốc tế"
                        ),
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 222:"),
                          " Xây dựng trung tâm tài chính quốc tế theo chuẩn mực quốc tế, kết nối thị trường toàn cầu"
                        )
                      )
                    ),

                    React.createElement('div', { className: "bg-orange-50 rounded-lg p-4" },
                      React.createElement('h4', { className: "font-semibold text-orange-900 mb-2" }, "⚡ Về tính chất:"),
                      React.createElement('ul', { className: "list-disc ml-6 space-y-2 text-gray-700" },
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 05:"),
                          " Mang tính thí điểm trong 5 năm, tập trung vào tài sản mã hóa"
                        ),
                        React.createElement('li', null,
                          React.createElement('strong', null, "NQ 222:"),
                          " Mang tính chiến lược dài hạn, tạo khu vực đặc thù với cơ chế chính sách riêng cho TTTCQT"
                        )
                      )
                    )
                  )
                ...
                React.createElement(React.Fragment, null,
                  React.createElement('button', { 
                    ...
                    React.createElement('h2', { className: "text-xl font-bold text-green-800" }, section.title),
                    expandedSections[section.id] ? 
                      React.createElement(ChevronDown, { className: "w-6 h-6 text-green-600" }) : 
                      React.createElement(ChevronRight, { className: "w-6 h-6 text-green-600" })
                  ),
                  
                  expandedSections[section.id] && React.createElement('div', { className: "pb-6 pl-4" },
                    section.content.map((subsection, idx) =>
                      React.createElement('div', { key: idx, className: "mb-4" },
                        React.createElement('h3', { className: "font-semibold text-lg text-gray-800 mb-3" }, subsection.subtitle),
                        React.createElement('ul', { className: "space-y-2" },
                          subsection.items.map((item, itemIdx) =>
                            React.createElement('li', { key: itemIdx, className: "flex items-start gap-3" },
                              React.createElement('span', { className: "text-green-600 mt-1" }, "•"),
                              React.createElement('span', { className: "text-gray-700 flex-1" }, item)
                            )
                          )
                        )
                      )
        ...
        // Footer
        React.createElement('div', { className: "bg-gradient-to-r from-green-700 to-emerald-600 text-white p-6 rounded-b-2xl" },
          React.createElement('div', null,
            React.createElement('p', { className: "font-semibold" }, "📅 Tài liệu được tổng hợp từ:"),
            React.createElement('p', { className: "text-sm text-green-100" }, "Nghị quyết 05/2025/NQ-CP và 222/2025/QH15")
          )
        )
      ),
      ...
      React.createElement('div', { className: "grid md:grid-cols-3 gap-4 mt-6" },
        React.createElement('div', { className: "bg-white rounded-xl p-4 shadow-lg border-l-4 border-green-600" },
          React.createElement('h3', { className: "font-bold text-green-800 mb-2" }, "📊 Vốn điều lệ"),
          React.createElement('p', { className: "text-2xl font-bold text-green-600" }, "10,000 tỷ"),
          React.createElement('p', { className: "text-sm text-gray-600" }, "Tối thiểu cho VASP")
        ),
        
        React.createElement('div', { className: "bg-white rounded-xl p-4 shadow-lg border-l-4 border-blue-600" },
          React.createElement('h3', { className: "font-bold text-blue-800 mb-2" }, "⏱️ Thời gian"),
          React.createElement('p', { className: "text-2xl font-bold text-blue-600" }, "5 năm"),
          React.createElement('p', { className: "text-sm text-gray-600" }, "Thí điểm thị trường")
        ),
        
        React.createElement('div', { className: "bg-white rounded-xl p-4 shadow-lg border-l-4 border-purple-600" },
          React.createElement('h3', { className: "font-bold text-purple-800 mb-2" }, "🏢 Số lượng VASP"),
          React.createElement('p', { className: "text-2xl font-bold text-purple-600" }, "Tối đa 05"),
          React.createElement('p', { className: "text-sm text-gray-600" }, "Tổ chức được cấp phép")
        )
      )
    )
  );
...
window.VASPComprehensiveDoc = VASPComprehensiveDoc;
